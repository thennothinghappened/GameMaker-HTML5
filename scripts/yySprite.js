...
class yySprite {
    ...
    GetCollisionChecking() { return this.colcheck === yySprite_CollisionType.PRECISE; }
    GetXOrigin() { return this.xOrigin; }
    GetYOrigin() { return this.yOrigin; }
    GetBoundingBox() { return this.bbox; }
    GetCount() { return this.numb; }
     ...
     */
    GetSkeletonSpriteSize(_skeleton) {
        // @if feature("spine")
     ...
     * @returns {Boolean}
     */
    GetSkeletonBounds(_skeleton, _bounds) {
        var retval = false;
        // @if feature("spine")
    ...
    GetScaledBoundingBox(_xscale, _yscale) {
    ...
    ///           </summary>
    // #############################################################################################
    BuildSWFData(_swfIndex, _xo, _yo) {
        // @if feature("swf")
        try {
    ...
    ///          </summary>
    // #############################################################################################
    SetupSWFCollisionMasks(_dataView, _byteOffset, _littleEndian) {
        // @if feature("swf")
    ...
    ///           </summary>
    // #############################################################################################
    BuildSkeletonData(_skeletonData) {
        // @if feature("spine")
        if (_skeletonData) {
    ...
    ///           </summary>
    // #############################################################################################
    LoadFromSpineAsync(_filename, _callback) {
        // @if feature("spine")
    ...
    ///           </summary>
    // #############################################################################################
    BuildSequenceData(_sequenceData) {
    ...
    ///           </summary>
    // #############################################################################################
    BuildNineSliceData(_ninesliceData) {
        // @if feature("nineslice")
        this.nineslicedata = new yyNineSliceData(_ninesliceData);
        // @endif
    }
    GetSkeletonSlotsAtPoint(_inst, _x, _y, _list) {
        // @if feature("spine")
    ...
    Sprite_DrawSimplePos(_sub_image, _x1, _y1, _x2, _y2, _x3, _y3, _x4, _y4, _alpha) {
    ...
    CollisionTilemapLine(bb2, xl, yl, xr, yr) {
        if ((xr - xl == 0) && (yr - yl == 0)) {
    ...
    CollisionTilemapEllipse(bb2, xl, yl, xr, yr) {
    ...
    PreciseCollisionTilemapRect(tMaskData, bb2, t_ibbox, xl, yl, xr, yr, sprwidth) {
    ...
    PreciseCollisionTilemapLine(tMaskData, bb2, t_ibbox, xl, yl, xr, yr, sprwidth) {
    ...
    PreciseCollisionTilemapEllipse(tMaskData, bb2, t_ibbox, xl, yl, xr, yr, sprwidth) {
        var l = yymax(xl, bb2[0].x);
    ...
    PreciseCollisionTilemap(img1, bb1, _x1, _y1, scale1x, scale1y, angle1, bb2, t_ibbox, tMaskData, sprwidth) {
    ...
    ///			 </returns>
    // #############################################################################################
    PreciseCollisionPoint(_img1, _bb1, _x1, _y1, _scalex, _scaley, _angle, _x, _y) {
        var xx, yy;
    ...
    ///			 </returns>
    // #############################################################################################
    PreciseCollisionRectangle(_img1, _bb1, _x1, _y1, _scalex, _scaley, _angle, _rr) {
        if (!this.maskcreated) return true; // When no mask it is always true
    ...
    ///			 </returns>
    // #############################################################################################
    PreciseCollisionEllipse(_img1, _bb1, _x1, _y1, _scalex, _scaley, _angle, _rr) {
        var i, j;
        if (!this.maskcreated) return true; // When no mask it is always true
    ...
    ///			 </returns>
    // #############################################################################################
    PreciseCollision(_img1, _bb1, _x1, _y1, _scale1x, _scale1y, _angle1, _pSpr, _img2, _bb2, _x2, _y2, _scale2x, _scale2y, _angle2) {
        // Some easy cases
    ...
    OrigPreciseCollision(_img1, _bb1, _x1, _y1, _scale1x, _scale1y, _angle1, _pSpr, _img2, _bb2, _x2, _y2, _scale2x, _scale2y, _angle2) {
        // Some easy cases
        if (_pSpr == null) return false;
    ...
    ///			 </returns>
    // #############################################################################################
    PreciseCollisionLine(_img1, _bb1, _x1, _y1, _scalex, _scaley, _angle, _xl, _yl, _xr, _yr) {
    ...
    SWFLoad(_data) {
        ...
        try {
            ...
            if (type == "rswf") {
                ...
                var version = nextString(dataview), versionInfo = version.split('.', 3);
                ...
                var headerSize = parseInt(nextString(dataview)), spriteCount = parseInt(nextString(dataview));
