...
class yyFont {
    ...
    ///           </summary>
    // #############################################################################################
    CreateFromSprite(_spr, _first, _prop, _sep, _stringmap) {
    ...
    ///			 </returns>
    // #############################################################################################
    TextWidthN(_str, _start, _numChars, _charSpacing) {
    ...
    ///			 </returns>
    // #############################################################################################
    Draw_String_GL_Full(_x, _y, _pStr, _xscale, _yscale, _angle, _col1, _col2, _col3, _col4, _charSpacing, _wordSpacing) {
        // @if feature("gl")
    ...
    ///          </summary>
    // #############################################################################################
    Draw_String_GL(_x, _y, _pStr, _xscale, _yscale, _angle, _col1, _col2, _col3, _col4, _charSpacing, _wordSpacing, _pFontParams) {
        // @if feature("gl")
        if (this.runtime_created) {
            //original
        ...
        var v0 = index, v1 = v0 + stride, v2 = v1 + stride, v3 = v2 + stride, v4 = v3 + stride, v5 = v4 + stride;
        ...
        //}
        var skip = 0;
        var s_growth = this.growth, invWidth = 1.0 / TP.texture.width, invHeight = 1.0 / TP.texture.height;
        ...
        for (var i = 0; i < len; i++) {
            ...
            if (pGlyph) {
                ...
                if ((pGlyph.w * pGlyph.h) > 0) // don't draw zero-size glyphs (like spaces)
                {
                    var ws = pGlyph.w + 2, hs = pGlyph.h + 2;
                    ...
                    var xs = pGlyph.x - 1, ys = pGlyph.y - 1;
    ...
    ///			 </returns>
    // #############################################################################################
    Draw_String(_x, _y, _pStr, _xscale, _yscale, _angle, _col1, _col2, _col3, _col4, _charSpacing, _wordSpacing) {
        // @if feature("2d")
    ...
    ///			 </returns>
    // #############################################################################################
    Draw_Sprite_String(_x, _y, _pStr, _xscale, _yscale, _angle, _col1, _col2, _col3, _col4, _charSpacing, _wordSpacing) {
        // @if feature("2d")
    ...
    ///			 </returns>
    // #############################################################################################
    Draw_Sprite_String_GL(_x, _y, _pStr, _xscale, _yscale, _angle, _c1, _c2, _c3, _c4, _charSpacing, _wordSpacing) {
        // @if feature("gl")
        if (this.pSprites == null) return;
...
class yyFontManager {
    ...
    Start_Rendering_SDF(_pFont, _shadowPass, _pEffectOverride) {
    ...
    Should_Render_Drop_Shadow(_pFont, _pEffectOverride) {
    ...
    // #############################################################################################
    // @if feature("fonts")
    Split_TextBlock(_pStr, linewidth, thefont) {
    ...
    ///			 </returns>
    // #############################################################################################
    Split_TextBlock_IDEstyle(_pStr, _boundsWidth, _boundsHeight, _alignment, _wrap, _charSpacing, _lineSpacing, _paraSpacing) {
    ...
    ///			 </returns>
    // #############################################################################################
    GR_Text_Draw(_str, x, y, linesep, linewidth, _angle, _xscale, _yscale, _c1, _c2, _c3, _c4) {
    ...
    ///			 </returns>
    // #############################################################################################
    GR_StringList_Draw_IDEstyle(_sl, _x, _y, _charSpacing, _clipLeft, _clipRight, _pFontParams) {
        if (_sl == null)
            return;
    ...
    ///           </summary>
    // #############################################################################################
    GR_Text_Sizes(_str, x, y, linesep, linewidth) {
