...
/**@constructor*/
class yyInstance {
    constructor(_xx, _yy, _id, _objectind, _AddObjectLink, _create_dummy) {
    ...
    */
    ...
    SetDirtyBBox(flag) { this.bbox_dirty = flag; }
    GetDirty() { return this.bbox_dirty; }
    SetInSequence(flag) { this.fInSequence = flag; }
    GetInSequence() { return this.fInSequence; }
    SetOwnedBySequence(flag) { this.fOwnedBySequence = flag; }
    GetOwnedBySequence() { return this.fOwnedBySequence; }
    SetControllingSeqInst(_pSeqInst) { this.m_pControllingSeqInst = _pSeqInst; }
    GetControllingSeqInst() { return this.m_pControllingSeqInst; }
    SetControlledBySequence(flag) { this.fControlledBySequence = flag; }
    GetControlledBySequence() { return this.fControlledBySequence; }
    SetDrawnBySequence(flag) { this.fDrawnBySequence = flag; }
    GetDrawnBySequence() { return this.fDrawnBySequence; }
    // #############################################################################################
    /// Function:<summary>
    ...
    // #############################################################################################
    Assign(_pInst, _LinkToObjectType) {
    ...
    ///				
    // #############################################################################################
    SetObjectIndex(_objindex, _LinkToObjectType, _SetDepthNow) {
    ...
    BuildPhysicsBody() {
        ...
        var physicsData = this.pObject.PhysicsData, xoffs = 0.0, yoffs = 0.0;
    ...
    // #############################################################################################
    PerformEvent(_event, _index, _pInst, _pOther, _pInstObject) {
    ...
    ///			 <param name="_pOther">the OTHER to use in the event</param>
    // #############################################################################################
    PerformEventInherited(_event, _index, _pOther) {
    ...
    ///			 </returns>
    // #############################################################################################
    Collision_Rectangle(_x1, _y1, _x2, _y2, _prec) {
        if (this.marked) return false;
    ...
    ///			 </returns>
    // #############################################################################################
    Collision_Ellipse(_x1, _y1, _x2, _y2, _prec) {
    ...
    ///			 </returns>
    // #############################################################################################
    Collision_Line(_x1, _y1, _x2, _y2, _prec) {
    ...
    ///			 </returns>
    // #############################################################################################
    Collision_Instance(_pInst, _prec) {
    ...
    ///			</returns>
    // #############################################################################################
    Assign_Path(_ind, _speed, _scale, _orient, _absolute, _endact) {
    ...
    ///          </summary>
    // #############################################################################################
    ApplyVisualOffset(_angle, _visualOffs) {
    ...
    // #############################################################################################
    // @if feature("physics")
    RefreshPhysicalProperties(_physicsBody) {
    ...
    ///          </summary>
    // #############################################################################################
    set_physics_linear_velocity_x(_vel) {
    ...
    ///          </summary>
    // #############################################################################################
    set_physics_linear_velocity_y(_vel) {
    ...
    ///          </summary>
    // #############################################################################################
    set_physics_angular_damping(_damping) {
    ...
    ///          </summary>
    // #############################################################################################
    set_physics_linear_damping(_damping) {
    ...
    ///          </summary>
    // #############################################################################################
    set_physics_fixed_rotation(_isFixed) {
    ...
    CollisionImageIndex(_consumeFrameOverflow) {
        // @if feature("spine")
    ...
    GetLayerID() { return this.m_nLayerID; }
    SetLayerID(_layerID) { this.m_nLayerID = _layerID; }
    GetOnActiveLayer() { return this.m_bOnActiveLayer; }
    SetOnActiveLayer(_onLayer) { this.m_bOnActiveLayer = _onLayer; }
}
